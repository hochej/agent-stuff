...
def get_grounded_response(prompt: str, model: str = None) -> str:
    ...
    try:
        ...
        config = types.GenerateContentConfig(
            ...
            # Use a slightly more descriptive system instruction if prompt is provided
            system_instruction="You are a helpful assistant that provides grounded answers using Google Search. Always cite your information."
        )
